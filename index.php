...
<body>
  ...
  <div class="button" align="center" style="background-color:#b91c1c;padding:10px;border-radius:80px 80px 0px 0px">
    <button type="button" name="homepagebutton" onclick="location.href='homepage.html'">Home Page</button>
  </div>
  </link>
  <div align="center" style="background-color:#ef4444;padding:150px;">
...
<div align="center" style="background-color:#b91c1c;padding:60px;border-radius:0px 0px 80px 80px">
<?php
