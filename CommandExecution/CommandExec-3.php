<html>
  ...
  <body>
    <div style="background-color:#b91c1c;padding:15px;border-radius:20px 20px 0px 0px">
      <button type="button" name="homeButton" onclick="location.href='../homepage.html';">Home Page</button>
      <button type="button" name="mainButton" onclick="location.href='commandexec.html';">Main Page</button>
    </div>
    <div style="background-color:#b91c1c;padding:20px;">
  ...
  <div style="background-color:#b91c1c;padding:20px;border-radius:0px 0px 20px 20px" align="center">
    <?php
